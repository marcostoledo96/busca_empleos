...
(Previously: la cancelación no exigía congelar un estado operativo ni impedía explícitamente el éxito falso.)
...
(Previously: la observabilidad exigía métricas, pero no definía el contrato público seguro ni los conteos de la cancelación.)

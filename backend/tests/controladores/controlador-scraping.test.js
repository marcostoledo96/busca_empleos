...
describe('Controlador de scraping', () => {
    ...
    // === POST /api/scraping/infojobs (inactiva en registry) ===

    describe('POST /api/scraping/infojobs (inactiva en registry)', () => {
        test('responde desactivado con datos del registry sin llamar al servicio', async () => {
            const res = await request(app)
            ...
            // No debe llamar al servicio de scraping ni a la BD.
    ...
    describe('POST /api/scraping/google-jobs', () => {
        test('responde desactivado con datos del registry sin llamar al servicio ni guardar ofertas', async () => {
            const res = await request(app)
                .post('/api/scraping/google-jobs')

...
//
// Cada endpoint dispara un scraping contra una plataforma (LinkedIn o Computrabajo),
// normaliza los resultados, los guarda en la base de datos, y devuelve un resumen
// con contadores: cuántas se extrajeron, cuántas se guardaron, cuántas eran duplicadas.
//
...
module.exports = { scrapearLinkedin, scrapearComputrabajo };
